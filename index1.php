    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-on-scroll stagger" data-tab-content="all" data-tab-group="featured">
            ...
            <?php 
                ...
                $highestPrice = $productData['priceDetails']['highest'] ?? 0;
            ...
            ?>
            <a href="/product.php?id=<?php echo $productId; ?>" class="group">
                <div class="bg-white rounded-2xl overflow-hidden shadow-soft hover-card transition-all duration-300">
                    <div class="relative aspect-square overflow-hidden">
                        <img src="<?php echo $imgUrl; ?>" alt="<?php echo htmlspecialchars($productData['name']); ?>" class="w-full h-full object-cover transform group-hover:scale-105 transition duration-500">
                        <button class="wishlist-btn absolute top-4 right-4 bg-white/80 backdrop-blur-sm p-2 rounded-full hover:bg-white transition z-10" data-product-id="<?php echo $productId; ?>">
                        ...
                        <div class="absolute inset-0 bg-dark/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                            <div class="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                <button type="button" class="bg-white/90 backdrop-blur-sm hover:bg-white text-dark py-2 px-4 rounded-lg text-sm font-medium transition" onclick="event.preventDefault(); showQuickView('<?php echo $productId; ?>')">
                                    Quick view
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="p-4">
                        ...
                        <h3 class="font-medium mb-2 line-clamp-2 group-hover:text-primary transition"><?php echo htmlspecialchars($productData['name']); ?></h3>
